...
async function createReservation(data) {
    // Vérifier que la place existe et appartient bien à l'événement via seat_id
    ...
    try {
        ...
        // Intercepter la violation de la contrainte UNIQUE (place déjà prise)
...
async function deleteReservation(id, requestingUser) {
    ...
    // Un user ne peut supprimer que ses propres réservations, un admin peut tout supprimer
